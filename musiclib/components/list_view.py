...
class ListViewItem(QtWidgetElement[QtWidgets.QWidget]):
    ...


class ListView(QtWidgetElement[QtWidgets.QListWidget]):
    """Widget to display a a list of items.
    ...
    def _initialize(self):
        self.underlying = QtWidgets.QListWidget()
